...
async function verificaProdutos() {
  ...
  ( 
    ...
    rq.[Data compra] >= DATEADD(DAY, -45, GETDATE()) AND
    ...
    if (coletas.length != 0) {
        this.html = this.html + `
            <h2 style="color: #0000cd;">Compras no estado Não Aprovada</h2>
            <p>&nbsp;</p>
    ...
    for (i = 0; i <= coletas.length -1; i++) {
        ...
        Valor_total = parseFloat(coletas[i].Valor_total).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', minimumFractionDigits: 2 });
        ...
        this.html = this.html + "<tr> " +
            ...
            ' <td style="width:150px; text-align: center"> ' + Valor_total + ' </td> ' +
 ...
 //             destinatario: "luis.espoladore@adcon.srv.br",
            destinatario: "luis.espoladore@adcon.srv.br;andreia.oliveira@iql.com.br;ivan.silva@iql.com.br;compras.iql@iql.com.br;samuel.corazza@adcon.srv.br,angelica.silva@iql.com.br;julio.correa@iql.com.br;denis.reis@iql.com.br",
//            destinatario: "luis.espoladore@adcon.srv.br;andreia.oliveira@iql.com.br;ivan.silva@iql.com.br;compras.iql@iql.com.br;samuel.corazza@adcon.srv.br",
            ...
            subject: "Compras Aguardando Aprovação - " + data,
            idsolicitante: 2,
